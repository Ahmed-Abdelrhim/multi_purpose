<!-- footer starts here -->
<footer>
    <button class="fas" id="backtotopbutton">
    ...
    <div class="footercontainer">
        ...
        <div class="social-media-container">
            ...
            <div class="logos">
                <a href="" target="_blank" tabindex="0" aria-label="My instagram">
                    <svg viewBox="0 0 448 512" class="SocialHandle">
                        <path
                ...
                <a href="" target="_blank" aria-label="My github">
                ...
                <a href="mailto:@gmail.com" target="_blank" aria-label="My G mail">
        ...
        <div class="footer-bottom">
            <article>
                <i class="far fa-copyright"></i> Elite Technology , All Right Reserved
            </article>
        </div>
    </div>
</footer>
