                                ...
                                @foreach ($recent_posts as $recent_post)
                                    <div class="recent-post-item clearfix">
                                        ...
                                        <div class="recent-post-body">
                                            ...
                                            <p class="recent-post-date"><i class="far fa-calendar-alt"></i>{{ Carbon\Carbon::parse($blog->created_at)->isoFormat('DD') }} {{ Carbon\Carbon::parse($blog->created_at)->isoFormat('MMMM') }} {{ Carbon\Carbon::parse($blog->created_at)->isoFormat('GGGG') }}</p>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
