...
<head>
    ...
    <meta name="author" content="creative Gate">
                ...
                <nav class="navbar navbar-expand-lg p-0">
                    ...
                    @else
                        <a class="navbar-brand" title="Home" href="#">
                            <img src="{{ asset('uploads/img/dummy/md-logo.png') }}" alt="Logo White" class="img-fluid logo-transparent">
                            <img src="{{ asset('uploads/img/dummy/md-logo.png') }}" alt="Logo Black" class="img-fluid logo-normal">
                        </a>
                    @endif
                ...
                <div class="container">
                    ...
                    <div class="row">
                        @foreach ($counters as $counter)
                            <div class="col-md-3 wow fadeInUp" data-wow-duration="0.7s" data-wow-delay="0.{{ $loop->index + 1 }}s">
                            ...
                            <div class="contact-form-wrap">
                                <form>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="contact-form-group">
                                                <input type="text" class="form-control" name="contact_name" id="contactName" placeholder="الاسم *">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="contact-form-group">
                                                <input type="text" class="form-control" name="subject" id="contactPhone" placeholder="رقم الهاتف">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="contact-form-group">
                                                <input type="text" class="form-control" name="contact_email" id="contactEmail" placeholder="الاميل *">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="contact-form-group">
                                                <textarea name="contact_message" id="contactMessage" class="form-control"  placeholder="اكتب رسالتك *" cols="20" rows="8"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12 text-center">
                                            <div class="contact-btn-left">
                                                <button type="submit" id="contactBtn" class="primary-btn">
                                                    <span class="text">ارسال الرسالة</span>
                                                    <span class="icon"><i class="fa fa-arrow-right"></i></span>
                                                </button>
                                            </div>
                                        </div>
    ...
    @endif
      ...
      @if (!empty($contact_section->map_iframe))
        ...
        @if (isset($work_process_section) || count($work_processes) > 0)
            <section class="section bg-primary-light pb-30">
                <div class="">
                    @isset ($work_process_section)
                        ...
                        @foreach ($work_processes->chunk(3) as $work_process)
                            ...
                            @foreach ($work_process as $item)
                                        <div class="col-md-2 wow fadeInUp" data-wow-duration="0.7s" data-wow-delay="0.{{ $i++ }}s">
                                            <div class="how-i-work-item">

                                                @if ($item->image_status == "enable" && !empty($item->work_process_image))

                                                        <img src="{{ asset('uploads/img/work_process/'.$item->work_process_image) }}" class="img-fluid" style="max-width: 50%;" alt="How i work">
        ...
        @else
            <footer class="footer">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-4 footer-widget-resp">
                                <div class="footer-widget">
                                    ...
                                    <img src="{{ asset('uploads/img/dummy/md-logo.png') }}" alt="footer logo" class="img-fluid footer-logo">
                                    <p class="footer-desc">
                                        It is a long established fact that a reader will be
                ...
                <div class="copyright">
                    <div class="container">
                        <p class="copyright-text">© Copyright 2023. Powered By creative Gate</p>
                    </div>
                </div>
            </footer>
    @endif
