...
<div class="page-wrapper">
    ...
    <header class="main-header">
        <div class="outer-container">
            <div class="logo-box"><a href="{{ url('/') }}"><img src="{{ asset('assets/admin/side_menu/vendor/preview/images/md-logo.png') }}" alt=""></a></div>
            <div class="menu-area clearfix">
                <nav class="main-menu navbar-expand-md navbar-light">
                    <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                        <ul class="navigation scroll-nav clearfix">
                            <li><a href="#demos">Demos</a></li>
                            <li><a href="mailto:creative Gate@gmail.com">Support</a></li>
                            <li><a href="https://creative Gate.com/documentation/digitalteam/" target="_blank">Documentation</a></li>
                        </ul>
                    </div>
                </nav>
            </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="lower-content">
                            <h5><a href="https://digitalteam.creative Gate.com/login" target="_blank">Admin Panel</a></h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="lower-content">
                            <h5><a href="https://digitalteam.creative Gate.com/" target="_blank">Frontend</a></h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
        ...
        <div class="product-sidebar">
            <div class="xs-sidebar-group info-group info-sidebar">
                <ul class="social-links clearfix">
                    ...
                    <li><a href="https://creative Gate.com/documentation/digitalteam/" target="_blank"><i class="icon fa fa-desktop"></i><span>Documentation</span></a></li>
                    <li><a href="mailto:creative Gate@gmail.com"><i class="icon fas fa-headset"></i></i><span>Support Center</span></a></li>
